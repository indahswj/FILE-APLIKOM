...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-004.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-005.png}
\begin{eulercomment}
3. Hitung luas segitiga tersebut.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-006.png}
\begin{eulercomment}
5. Gambar jari-jari lingkaran dalam.
\end{eulercomment}
\begin{eulerprompt}
...
>plotCircle(circleWithCenter(P,r),"Lingkaran dalam segitiga ABC"):
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-007.png}
\begin{eulercomment}
6. Hitung luas lingkaran luar dan luas lingkaran dalam segitiga ABC.
Adakah hubungan antara luas kedua lingkaran tersebut dengan luas
segitiga ABC?
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-009-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-011-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-017-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-021.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-023.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-033.png}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
H\left(a , b , c\right)=\frac{\left| a\right| \,\left| {\it ysol}  \right| }{2}
\]
\end{eulerformula}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-039-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-040.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-046-large.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Use global or local variables defined in function mxmeval.
  Try "trace errors" to inspect local variables after errors.
  mxmeval:
...
\begin{eulerformula}
\[
{\it distance}\left({\it lineIntersection}\left(  {\it middlePerpendicular}\left(A , \left[ 0 , 0 \right] \right) ,   {\it middlePerpendicular}\left(\left[ 0 , 0 \right]  , \left[ a , 0   \right] \right)\right) , \left[ 0 , 0 \right] \right)
\]
\end{eulerformula}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  Error in expression: lineIntersection(middlePerpendicular(A,[0,0]),middlePerpendicular([0,0],[a,0]))
  Error in:
...
\begin{eulerformula}
\[
\frac{c^2}{\sin ^2{\it computeAngle}\left(A , \left[ 0 , 0 \right]    , \left[ a , 0 \right] \right)}
\]
\end{eulerformula}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-050.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-054-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-067.png}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{25}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-070.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-073-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT GEOMETRI_INDAH SARI WIJAYANTI_23030630014_MAT B-076-large.png}
\begin{eulercomment}
