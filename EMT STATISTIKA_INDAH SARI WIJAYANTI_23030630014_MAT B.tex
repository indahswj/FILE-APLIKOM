...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-003.png}
\eulerheading{Tables}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Untuk kenyamanan, Anda dapat menaruh keluaran dari readtable() ke
dalam sebuah daftar.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-011.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-012.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-014.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-015.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-027.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-031.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-032.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-033.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-034.png}
\begin{eulercomment}
Menghapus data.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Produk luar di EMT hanya dapat dilakukan antar vektor. Ini otomatis
karena bahasa matriks. Satu vektor harus menjadi vektor kolom dan yang
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-037.png}
\eulerheading{Lists}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT STATISTIKA_INDAH SARI WIJAYANTI_23030630014_MAT B-038.png}
\begin{eulercomment}
